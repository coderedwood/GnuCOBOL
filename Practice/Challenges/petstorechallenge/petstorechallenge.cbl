       ...
       01  HEADING-LINE1.
		...
		01  DETAIL-SUBTOTAL-LINE1.
			...
			05 FILLER           PIC X(14)  VALUE 
			   "   SUB-TOTAL: ". 
			05 FILLER           PIC X.
			05 DET-SUBTOTAL-SALES     PIC $$,$$$,$$9.99.
       ...
       0110-WRITE-HEADING-LINES.
           ...
           ADVANCING PAGE.
           WRITE PRINT-LINE FROM HEADING-LINE1 AFTER
           ADVANCING 1 LINE.
	   0110-END.	
		   
       0200-PROCESS-ITEMS.
           MOVE 1 TO WS-INDEX
           MOVE 0 TO WS-ITEM-SUBTOTAL, WS-SUBTOTAL-QUANT.
           ...
           PERFORM 3 TIMES		   
		     ...
		     MOVE QUANTITY(1) TO DET-QUANTITY
	   	     ...
	   	     COMPUTE WS-ITEM-SUBTOTAL = WS-ITEM-TOTAL + 
               WS-ITEM-SUBTOTAL
		     COMPUTE WS-TOTAL-SALE = WS-TOTAL-SALE + 
               WS-ITEM-TOTAL
		     COMPUTE WS-TOTAL-QUANT = WS-TOTAL-QUANT + 
               QUANTITY(WS-INDEX)
             ADD QUANTITY(WS-INDEX) TO WS-SUBTOTAL-QUANT
		     
		     MOVE WS-ITEM-TOTAL TO DET-ITEM-TOTAL
             WRITE PRINT-LINE FROM DETAIL-LINE AFTER ADVANCING 1 LINE
             ADD 1 TO WS-INDEX
           END-PERFORM.  
		   MOVE WS-ITEM-SUBTOTAL TO DET-SUBTOTAL-SALES.
		   MOVE WS-SUBTOTAL-QUANT TO DET-SUBTOTAL-QUANT.
           WRITE PRINT-LINE FROM DETAIL-SUBTOTAL-LINE AFTER
               ADVANCING 1 LINE.
           WRITE PRINT-LINE FROM DETAIL-SUBTOTAL-LINE1 AFTER
               ADVANCING 1 LINE.
